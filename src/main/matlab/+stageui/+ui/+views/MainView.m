    ...
    methods
        ...
        function createUi(obj)
            ...
            set(obj.figureHandle, ...
                'Name', 'Stage Server', ...
            	'Position', screenCenter(hpix(330/11), vpix(226/16)));
            ...
            obj.standardBox = appbox.uix.BoxPanel( ...
            ...
            obj.advancedBox = appbox.uix.BoxPanel( ...
                'Parent', obj.parametersLayout, ...
                'Title', 'Advanced', ...
                'BorderType', 'none', ...
                'FontUnits', get(obj.figureHandle, 'DefaultUicontrolFontUnits'), ...
            ...
            set(obj.parametersLayout, ...
                'Heights', [-1 vpix(26/16)], ...
                'MinimumHeights', [vpix(155/16) vpix(26/16)]);
            ...
            set(mainLayout, 'Heights', [-1 vpix(23/16)+11+11]);
